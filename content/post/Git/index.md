...
**Введение**
Этот пост познакомит вас с системой контроля версий. Вначале изучим основы систем контроля версий, затем перейдём к тому, как запустить Git на ОС и окончательно настроить для работы. В конце получим окончательно настроенную для работы систему.
